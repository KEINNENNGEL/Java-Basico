...
import java.io.*;//realizando la importacion 
public class Sueldotrabajador {
    ...
    public static void main(String[] args) throws IOException  {
       ...
       // do{
        try{
        opcion = JOptionPane.showInputDialog("USTED DESEA SABER EL SALDO DEL EMPLEADO \n SI (s)\n NO (n) ");//pide al usuario si desea o no realizar la operacion
       if ("s".equals(opcion)){//declaracion de la sentencia if
        ...
        }//FIN DE LA SENTECIA IF
        else if ("n".equals(opcion)){//SI NO
        JOptionPane.showMessageDialog(null,"USTED A DESEADO SALIR DEL PROGRAMA");//MUESTRA EL MSJ 
    }
        }catch(Exception t){
            JOptionPane.showMessageDialog(null,":p ERROR");
        }
      //  }while(opcion!='n');
    }
}
